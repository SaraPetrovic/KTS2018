...
INSERT INTO users(id, document_verified, first_name, last_name, username, password, roles, user_type_demo, money_balance) VALUES (1, 3, 'Jovan', 'Lakovic', 'user1', '1234', 1, 1, 500.00)
...
insert into users(id, document, document_verified, first_name, last_name, money_balance, password, roles, user_type_demo, username) values (3, null, 1, 'Sara', 'Petrovic', 500, '123', 1, null, 'Sara')